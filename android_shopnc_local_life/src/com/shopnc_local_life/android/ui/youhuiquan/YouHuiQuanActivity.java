...
/**
 * Author:hjgang Create On 2013-8-26下午1:47:13 Site:http://weibo.com/hjgang or
...
public class YouHuiQuanActivity extends Activity implements OnScrollListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				YouHuiQuanList you = (YouHuiQuanList) listview
						.getItemAtPosition(arg2);
				Intent intent = new Intent(YouHuiQuanActivity.this,
						YouHuiQuanDetalisActivity.class);
	...
	public void ListViewInFo(int pangeno) {
		...
		if (myApp.getCity_id() == null || myApp.getCity_id().equals("0")
			...
			// dialog.dismiss();
			Toast.makeText(YouHuiQuanActivity.this, "城市没有获取到，请稍后重试",
		...
		String url = Constants.URL_COUPON_LIST + "&city_id="
		...
		RemoteDataHandler.asyncGet(url, new Callback() {
			...
			public void dataLoaded(ResponseData data) {
				...
				if (data.getCode() == HttpStatus.SC_OK) {
					...
					ArrayList<YouHuiQuanList> list = YouHuiQuanList
	...
	private void onRefresh(View view, String showText) {
		...
		Toast.makeText(YouHuiQuanActivity.this, showText, Toast.LENGTH_SHORT)
				.show();
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			...
			// ((MainActivity)
			// YouHuiQuanActivity.this.getParent()).dialog.show();
